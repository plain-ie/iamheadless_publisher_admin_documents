...
class DocumentPydanticModel(BaseItemPydanticModel):
    ...
    _display_name_plural = _('documents')
    _display_name_singular = _('document')
    ...
    def render_form(
        ...
        content_formset = forms.DocumentContentFormSet(initial=initial_contents, prefix=PREFIX_CONTENTS_FORMSET)
        form = forms.DocumentForm(initial=initial_item)

        if request.method == 'POST':
            content_formset = forms.DocumentContentFormSet(request.POST, initial=initial_contents, prefix=PREFIX_CONTENTS_FORMSET)
            form = forms.DocumentForm(request.POST, initial=initial_item)
