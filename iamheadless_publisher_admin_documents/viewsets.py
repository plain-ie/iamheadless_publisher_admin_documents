...
PYDANTIC_MODEL = pydantic_models.DocumentPydanticModel


class DocumentCreateViewSet(BaseItemCreateViewSet):
    ...
    def get_route(cls, prefix=''):
        ...
        path_pattern += r'tenants/<str:tenant_id>/'
...
class DocumentRetrieveUpdateViewSet(BaseItemRetrieveUpdateViewSet):
...
class DocumentDeleteViewSet(BaseItemDeleteViewSet):
